        ...
        <div className="p-8" ref={factureRef}>
          ...
          <div className="my-6 flex justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 w-52 wrap-break-word">
              ...
              <tbody>
                {invoice.lines.map((line, index) => (
                  <tr key={index + 1}>
                    ...
                    <td>{line.quantity}</td>
                    <td>{line.unitPrice.toFixed(2)} DT</td>
                    <td>{(line.quantity * line.unitPrice).toFixed(2)} DT</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-6 space-y-2 text-md">
            <div className="flex justify-between">
              ...
              <div>{totals.totalHT.toFixed(2)} DT</div>
            </div>

            {invoice.vatActive && (
              <div className="flex justify-between">
                <div className="font-bold">TVA {invoice.vatRate} %</div>
                <div>{totals.totalVAT.toFixed(2)} DT</div>
              </div>
            )}
